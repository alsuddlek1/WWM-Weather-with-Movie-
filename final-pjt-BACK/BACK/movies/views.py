...
def weather(request, lat, lon):
    ...
    # 날씨별 장르 추천
    genre_recommend = { 
        'Thunderstorm' : [27, 9648, 53], # 공포, 미스터리, 스릴러
        'Drizzle' : [12, 16, 99], # 이슬비 : 모험, 애니메이션, 다큐멘터리
        'Rain' : [80, 10752, 53, 27], # 범죄, 전쟁, 스릴러, 공포
        'Snow' : [18, 10751], # 가족, 드라마
        'Atmosphere' : [28, 14, 35], # 코미디, 액션, 판타지
        'Clear' : [10749, 10770], # 로맨스, tv 영화
        'Clouds' : [37, 36, 10402, 878], # 서부, SF, 역사, 음악
    }
